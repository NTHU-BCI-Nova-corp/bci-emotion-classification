...
def gen_training_matrix(directory_path, output_file, cols_to_ignore):
	...
	Parameters:
		...
		output_file (str): filename for the original_data_seed file.
...
if __name__ == '__main__':
	...
	Main function. The parameters for the script are the following:
		...
		[2] output_file: The filename of the generated original_data_seed file.
